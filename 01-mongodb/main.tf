...
locals {
  ...
  mongodb_atlas_org_id  = "6277d4210a7dfe3a480dd568"
  ...
  mongodb_atlas_database_username = "application"
  ...
  mongodb_atlas_accesslistip = "34.99.217.108"
}
